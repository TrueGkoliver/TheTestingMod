...
public class WaterParticleRenderer extends EntityRenderer<WaterParticleEntity>{
	...
	private static final ResourceLocation WATER_TEXTURE = new ResourceLocation("textures/entity/enderdragon/dragon_fireball.png");
	...
	public WaterParticleRenderer(EntityRendererManager renderManager) {
		super(renderManager);
		TheTestMod.LOGGER.debug("Constructor for the WaterParticleRenderer.");
	}
	@Override
	protected int getBlockLight(WaterParticleEntity entityIn, BlockPos partialTicks) {
		return 15;
	}
	@Override
	public void render(WaterParticleEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
